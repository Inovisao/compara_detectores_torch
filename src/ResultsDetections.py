...
def create_csv(selected_model, fold, root, model_path, save_imgs, tiling_mode=None):
    ...
    try:
        ...
        with results_path.open(mode="a", newline="") as file:
            ...
            if not file_exists:
                writer.writerow(["ml", "fold", "mAP", "mAP50", "mAP75", "MAE", "RMSE", "r", "precision", "recall", "fscore"])
