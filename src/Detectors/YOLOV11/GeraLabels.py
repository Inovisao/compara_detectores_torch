...
def CriarLabelsYOLOV11(fold: str, root_dir: str | Path) -> Path:
    ...
    output_root = dataset_root / "YOLOV11"
    ...
    data_yaml_path = dataset_root / "data_yolov11.yaml"
    _write_data_yaml(data_yaml_path, output_root, class_names, split_names)
    return data_yaml_path


__all__ = ["CriarLabelsYOLOV11"]
