...
def treino():
    ...
    model.train(
                ...
                epochs=3000, # Epocas que o Modelo ira Rodar
                imgsz=640, # Dimeção das imagens
                patience = 150, # paciencia para o modelo parar o treinamento geral mente se usa 10% das epocas
                batch = 4, # Tamanho do lote da GPU
